//! v0.6.0 Feature Demo - New Widgets and Enhancements
...
pub fn main() !void {
    ...
    var app = try phantom.App.init(allocator, .{
        .title = "Phantom v0.6.0 - New Features Demo",
        .tick_rate_ms = 50,
        .mouse_enabled = true,
    });
    defer app.deinit();

    std.debug.print("Phantom v0.6.0 Demo\n", .{});
    std.debug.print("==================\n\n", .{});
    ...
    std.debug.print("\n===================\n", .{});
    std.debug.print("All v0.6.0 features demonstrated successfully!\n\n", .{});

    std.debug.print("Key Improvements in v0.6.0:\n", .{});
